/*7. Write an applet that allow free hand drawing and WAP to
implement event handling that modifies the applet program for
diamond pattern in the following manner. The size of diamond given
in a text field and provides 3 choice list;

a. For selecting background color
b. For selecting foreground color
c. For selecting symbol for drawing diamond
...
/* <applet code="Applet Program.class" height="600" width="600"></applet>*/
